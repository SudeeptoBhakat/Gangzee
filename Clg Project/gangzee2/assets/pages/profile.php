...
<div style="background-color: #050505;">
    <div class="container col-md-9 col-sm-11 rounded-0" style="background-color: #050505;">
            ...
            <div class="col-md-8 col-sm-11">
                <div class="d-flex flex-column">
                    <div class="d-flex gap-5 align-items-center">
                        <span style="font-size: xx-large;" class="text-light"><?=$profile['first_name']?> <?=$profile['last_name']?></span>
...
if($user['id']!=$profile['id'] && !checkBS($profile['id'])){
  ...
  <div class="dropdown">
    ...
    <?php
                    ...
                    <span style="font-size: larger;" class="text-info">@<?=$profile['username']?></span>
                    <?php
...
<a class="btn btn-sm btn-info <?=count($profile['followers'])<1?'disabled':''?>" data-bs-toggle="modal" data-bs-target="#follower_list"><i class="bi bi-people-fill"></i> <?=count($profile['followers'])?> Followers</a>
<a class="btn btn-sm btn-info <?=count($profile['following'])<1?'disabled':''?>" data-bs-toggle="modal" data-bs-target="#following_list"><i class="bi bi-person-fill"></i> <?=count($profile['following'])?> Following</a>
...
<?php
   ...
   ?>
<button class="btn btn-sm btn-secondary unfollowbtn" style="width: 305px;" data-user-id='<?=$profile['id']?>' >Unfollow</button>
   
   <?php
}else{
    ?>
<button class="btn btn-sm btn-info followbtn" style="width: 305px;" data-user-id='<?=$profile['id']?>' >Follow</button>
