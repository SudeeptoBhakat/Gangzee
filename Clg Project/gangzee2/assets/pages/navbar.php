        ...
        <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12">
                <a class="navbar-brand" href="?">
                    <img src="assets/images/gangzee.png" alt="" height="40">

                </a>

                <form class="d-flex" id="searchform">
                    <style>.expanded-width {
                        width: 450px; /* Set the desired width value */
                    }
                    </style>
                    <input class="form-control me-2 expanded-width" type="search" id="search" placeholder="looking for someone.."
                        aria-label="Search" autocomplete="off">
                    <div class="expanded-width bg-white text-end rounded border shadow py-3 px-4 mt-5" style="display:none;position:absolute;z-index:+99;" id="search_result" data-bs-auto-close="true">
            ...
            <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-1 mb-sm-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="?"><i class="bi bi-house-door" style="color: White;"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" data-bs-toggle="modal" data-bs-target="#addpost" href="#"><i class="bi bi-plus-square" style="color: White;"></i></a>
                </li>
                <li class="nav-item">
 ...
 <a class="nav-link text-dark position-relative" id="show_not" data-bs-toggle="offcanvas" href="#notification_sidebar" role="button" aria-controls="offcanvasExample">
  ...
  <span class="un-count position-absolute start-10 translate-middle badge p-1 rounded-pill bg-danger">
   <small><?=getUnreadNotificationsCount()?></small>
    ...
    ?>
  <a class="nav-link text-dark" data-bs-toggle="offcanvas" href="#notification_sidebar" role="button" aria-controls="offcanvasExample"><i class="bi bi-bell" style="color: White;"></i></a>
    <?php
}
                    ?>
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="../../Clg Project\gangzee\About\index.php"><img src="assets/images/icon gangzee.png" style="height: 25px;"alt=""></a>
                </li>
